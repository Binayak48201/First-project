...
$allproducts = $query->counting('products');
          ...
          <div class="row">
            ...
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">Total Products</strong><span></span>
                  <div class="count-number"><?= $allproducts->Count; ?></div>
                </div>
              </div>
            </div>
            <!-- Count item widget-->
