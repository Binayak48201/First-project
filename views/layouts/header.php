...
<head>
    ...
    <!-- Linearicons -->
    <link href="../../public/vendors/linearicons/css/linearicons.css" rel="stylesheet">

    <!-- Owl Carousel -->
    <link href="../../public/vendors/owl-carousel/owl.carousel.min.css" rel="stylesheet">
    <link href="../../public/vendors/owl-carousel/owl.theme.min.css" rel="stylesheet">

    <!-- Flex Slider -->
    <link href="../../public/vendors/flexslider/flexslider.css" rel="stylesheet">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-8">
                            <ul class="nav-top nav-top-right list-inline t-xs-center t-md-right">
                                ...
                                <li><a href="views/master/signin.php"><i class="fa fa-user"></i>Sign Up</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row row-rl-0 row-tb-20 row-md-cell">
                        <div class="brand col-md-3 t-xs-center t-md-left valign-middle">
                            <a href="/" class="logo">
                                <img src="../../public/images/logo.png" alt="" width="250">
                            </a>
                        </div>
                ...
                <div class="container">
                    <nav class="nav-bar">
                                ...
                                <li class="dropdown-mega-menu">
                                    ...
                                    <div class="mega-menu">
                                        <div class="row row-v-10">
                                            ...
                                            <div class="col-md-3">
                                                <figure class="deal-thumbnail embed-responsive embed-responsive-4by3" data-bg-img="public/images/deals/deal_03.jpg">
                                            ...
                                            <div class="col-md-3">
                                                <figure class="deal-thumbnail embed-responsive embed-responsive-4by3" data-bg-img="public/images/deals/deal_04.jpg">
                                            ...
                                            <div class="col-md-3">
                                                <figure class="deal-thumbnail embed-responsive embed-responsive-4by3" data-bg-img="public/images/deals/deal_05.jpg">
                                                    <div class="label-discount top-10 right-10">-60%</div>
                                                    <div class="deal-about p-10 pos-a bottom-0 left-0">
                                                        <div class="rating mb-10">
                        ...
                        <div class="nav-menu nav-menu-fixed">
                            <a href="ar/index.html" target="_blank">RTL VERSION<i class="fa fa-long-arrow-right ml-10"></i></a>
                        </div>
                    </nav>
                </div>
            </div>
