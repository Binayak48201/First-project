                ...
                <div class="row row-tb-20">
                        ...
                        <div class="row row-tb-20">
                            <div class="footer-col col-sm-6">
                                <div class="footer-about">
                                    <img class="mb-40" src="public/images/logo_light.png" width="250" alt="">
                                ...
                                <div class="footer-top-instagram instagram-widget">
                                    ...
                                    <div class="row row-tb-5 row-rl-5">
                                        ...
                                        <div class="instagram-widget__item col-xs-4">
                                            <img src="public/images/instagram/instagram_01.jpg" alt="">
                                        </div>


                                        <div class="instagram-widget__item col-xs-4">
                                            <img src="public/images/instagram/instagram_02.jpg" alt="">
                                        </div>


                                        <div class="instagram-widget__item col-xs-4">
                                            <img src="public/images/instagram/instagram_03.jpg" alt="">
                                        </div>


                                        <div class="instagram-widget__item col-xs-4">
                                            <img src="public/images/instagram/instagram_04.jpg" alt="">
                                        </div>


                                        <div class="instagram-widget__item col-xs-4">
                                            <img src="public/images/instagram/instagram_05.jpg" alt="">
                                        </div>


                                        <div class="instagram-widget__item col-xs-4">
                                            <img src="public/images/instagram/instagram_06.jpg" alt="">
                                        </div>
                    ...
                    <div class="col-xs-12">
                        <div class="payment-methods t-center">
                            <span><img src="public/images/icons/payment/paypal.jpg" alt=""></span>
                            <span><img src="public/images/icons/payment/visa.jpg" alt=""></span>
                            <span><img src="public/images/icons/payment/mastercard.jpg" alt=""></span>
                            <span><img src="public/images/icons/payment/discover.jpg" alt=""></span>
                            <span><img src="public/images/icons/payment/american.jpg" alt=""></span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Modernizer JS -->
    <script src="../../public/vendors/modernizr/modernizr-2.6.2.min.js"></script>
    
    <!-- Owl Carousel -->
    <script type="text/javascript" src="../../public/vendors/owl-carousel/owl.carousel.min.js"></script>

    <!-- FlexSlider -->
    <script type="text/javascript" src="../../public/vendors/flexslider/jquery.flexslider-min.js"></script>

    <!-- Coutdown -->
    <script type="text/javascript" src="../../public/vendors/countdown/jquery.countdown.js"></script>
...
<!-- Mirrored from friday-theme.firebaseapp.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Oct 2018 05:10:56 GMT -->
</html>